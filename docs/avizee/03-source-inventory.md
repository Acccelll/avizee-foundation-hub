...
| DIV-10 a DIV-16 | Divergências internas do catálogo (códigos duplicados, medidas conflitantes, dois códigos para o mesmo produto, nomes de família divergentes) | S-03 vs. S-02 | Listadas integralmente em `18-catalog-audit.md`. **Não reconciliadas** — exigem decisão do usuário antes da modelagem. |
| DIV-17 | O grupo inteiro **SOCOREX** (15 SKUs) e os nomes `BV005`, `LM001`, `LM002` carregam marca de terceiro | S-03 vs. R-05 | **Não reconciliado.** Maior violação estrutural de R-05. Registrado como L-12. |
