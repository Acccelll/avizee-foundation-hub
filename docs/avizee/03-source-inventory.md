...
| DIV-05 | Site atual não tem páginas de produto individuais; a listagem inteira é renderizada em `/produtos` e os links "Detalhes" apontam para `#` | S-01 vs. S-02 | **Confirmado em S-02** (o site é PHP, não `.html`). Não há URL de SKU a preservar; RK-06 reduzido. Ver `19-url-inventory.md`. |
| DIV-06 (RESOLVIDA) | O prompt cita "grafismos inspirados na letra **V**"; o manual oficial não apresenta nenhum grafismo em "V" — o elemento gráfico é o símbolo cabeça de galo em traço contínuo fundido a meia engrenagem | S-08 vs. S-04 | **Resolvida 2026-08-01 (D-032)**: nenhum grafismo novo será criado; usa-se apenas o padrão secundário oficial, aplicado separado do símbolo. |
...
| DIV-08 | O acervo de imagens contém prefixos ausentes do site atual (`BB`, `CO`, `PE`, `SE`) e o site contém códigos ausentes do acervo (`AG001`, `AG021`, `AZ004`) | S-05 vs. S-01 | **Explicado por S-03**: `PE` pertence ao catálogo complementar (55 SKUs fora do site). Cobertura calculada em `18-catalog-audit.md`. |
| DIV-10 a DIV-16 | Divergências internas do catálogo (códigos duplicados, medidas conflitantes, dois códigos para o mesmo produto, nomes de família divergentes) | S-03 vs. S-02 | Listadas em `18-catalog-audit.md`. **Tratamento definido (D-036)**: UUID é a chave; cada conflito bloqueia apenas o registro afetado, que fica em rascunho. |
| DIV-17 (RESOLVIDA) | O grupo inteiro **SOCOREX** (15 SKUs) e os nomes `BV005`, `LM001`, `LM002` carregam marca de terceiro | S-03 vs. R-05 | **Resolvida 2026-08-01 (D-035)**: renomear por função; a marca original permanece somente em campo interno. |
