...
REVOKE ALL ON FUNCTION public.increment_schedule_attempts(uuid, text) FROM PUBLIC, anon, authenticated;
...
GRANT EXECUTE ON FUNCTION public.increment_schedule_attempts(uuid, text) TO service_role;
